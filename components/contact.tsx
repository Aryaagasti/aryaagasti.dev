...
export default function Contact() {
  ...
  return (
    <section id="contact" className="py-20">
      <SectionHeading title="Contact Me" subtitle="Get in touch with me for collaborations or opportunities" />
            ...
            <CardContent className="p-6 flex flex-col h-full">
              ...
              <div className="space-y-6 flex-grow">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a
                      href="mailto:arya.agasti@example.com"
                      className="text-foreground/70 hover:text-primary transition-colors"
                    >
                      aryaagasti@gmail.com
                    </a>
                  </div>
                </div>
              ...
              <div className="mt-8">
                ...
                <div className="flex gap-4">
                  ...
                  <a
                    href="https://www.linkedin.com/in/arya-agasti-56234018b/"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-10 h-10 rounded-full bg-primary/10 flex items-center justify-center hover:bg-primary/20 transition-colors"
                  >
                ...
                {process.env.NODE_ENV === 'development' && (
                  <div className="mt-4 text-xs text-foreground/50">
                    <a href="/admin/messages" className="hover:text-primary transition-colors">
                      View Messages (Admin)
                    </a>
                  </div>
                )}
